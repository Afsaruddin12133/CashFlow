...
public class Budget   extends Goal{

    public static JPanel createBudgetInPanel() {
        ...
        JLabel titleLabel = new JLabel("Make Goal");
        ...
        JLabel emailLabel = new JLabel("Goal Categories:");
        ...
        JLabel passowLabel = new JLabel("Goal  Massage: ");
        ...
        RoundedButton button = new RoundedButton("Goal");
        ...
        JLabel dateLabel = new JLabel("Goal Date:");
