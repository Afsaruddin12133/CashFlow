...
public class Deposit extends Expense {

    public static JPanel createDepositInPanel() {
        ...
        JLabel emailLabel = new JLabel("Deposit Categories:");
        ...
        JLabel passowLabel = new JLabel("Deposite Massage: ");
        ...
        RoundedButton button = new RoundedButton("Deposit");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(null, "Deposite Success.", "Success",
